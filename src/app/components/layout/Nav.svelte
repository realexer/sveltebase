	...
	<div class="nav-wrapper">
		<ul class="">
			<li class:active="{$page.path == lang_url()}">
				<a  href='{lang_url()}'>
					<span class="brand-logo" style="position: relative;"><Lang key="layout.nav.links.home.text"/></span>
				</a>
			</li>
			...
			<li class:active="{$page.path == lang_url('info/showcase')}">
				<a href="{lang_url('info/showcase')}" title="{_lang('layout.nav.links.showcase.title')}">
					<span><Lang key="layout.nav.links.showcase.text"/></span>
				</a>
			</li>
